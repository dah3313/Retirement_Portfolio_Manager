...
Crisis Mode Cascading Withdrawals: If the 18 month SGOV buffer is exhausted, withdrawals transition to pulling from Fixed Income assets, once Fixed Income is exhausted at approximately the 8 year mark last resort withdrawals transition to Growth assets.
